      ...
      <div className="mx-auto max-w-5xl">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div className="col-span-1 md:col-span-8 text-center flex flex-col justify-center px-1">
            <h1 className="font-gothic font-normal text-tertiary text-4xl md:text-6xl md:mb-4 mb-2">Alex Heisenberg</h1>
            <h2 className="font-gothic font-extralight text-tertiary text-2xl md:text-3xl pb-2">I'm a Software Engineer</h2>
